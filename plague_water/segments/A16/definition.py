...
piano_rh_context_maker = new(piano_rh_context_maker,
    music_makers=(
        new(music_maker, chord_agent=music_maker.chord_agent.rotate(3)),
        ),
    )
...
percussion_shaker_context_maker = new(percussion_shaker_context_maker,
    music_makers=(
        new(music_maker, pitch_agent=music_maker.pitch_agent.rotate(5)),
        ),
    )
...
percussion_drum_context_maker = new(percussion_drum_context_maker,
    music_makers=(
        new(music_maker, pitch_agent=music_maker.pitch_agent.rotate(4)),
        ),
    )
