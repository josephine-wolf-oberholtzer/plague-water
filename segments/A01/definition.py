...
context_map['Plague Water Score']['pitch_agent'] = new(
    context_map['Plague Water Score']['pitch_agent'].rotate(0),
    )
...
context_map['Piano RH Voice']['register_agent'] = makers.RegisterAgent(
    ...
    phrase_inflections=makers.RegisterCurve(
        ratio=(1,),
        registers=(-12, 0),
        ),
    )
...
piano_rh_context_maker = new(piano_rh_context_maker,
    music_makers=(
        new(music_maker, chord_agent=music_maker.chord_agent.rotate(0)),
        ),
    )
...
percussion_shaker_context_maker = new(percussion_shaker_context_maker,
    music_makers=(
        new(music_maker, pitch_agent=music_maker.pitch_agent.rotate(0)),
        ),
    )
