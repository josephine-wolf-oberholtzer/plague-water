...
from plague_water.segments import PaletteC

### BASE SEGMENT MAKER ###

base_segment_maker = PaletteC.segment_maker
...
context_map['Plague Water Score']['pitch_agent'] = new(
    context_map['Plague Water Score']['pitch_agent'].rotate(4),
    )
...
context_map['Guitar Voice']['register_agent'] = makers.RegisterAgent(
    global_inflections=NamedPitch('F#3'),
    )
context_map['Piano RH Voice']['register_agent'] = makers.RegisterAgent(
    global_inflections=NamedPitch('Eb5'),
    )
