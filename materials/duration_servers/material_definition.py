...
_euler_hundreds = [int('{}{}'.format(_x, _y)) for _x, _y in
    sequencetools.iterate_sequence_nwise_strict(_euler_numbers, 2)]
...
long_duration_server = datastructuretools.StatalServer((
    durationtools.Duration(x, _denominator) for x in
    sequencetools.remap_sequence_by_range_pairs(
        _euler_hundreds,
        [
            ((0, 49), (6, 12)),
